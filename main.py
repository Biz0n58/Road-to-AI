...
#-----------------------------------------------------------------------------------------------------------------------------------------#
#Lists
Children = ["Ali", "Sara", "mohamed", "Mercer", "Ali"]
print(Children.index("Mercer") )# Returns the index of the first occurrence of "mohamed" in the list
print(Children.pop(1)) # Removes and returns the element at index 1 (Sara)
print(Children.count("Ali")) # Returns the number of times "mohamed" appears in the list
print(Children.insert(2, "Ahmed")) # Adds "Ahmed" to the end of the list
print(Children.remove("Mercer")) # Removes the first occurrence of "Mercer" from the list
print(Children) # Output: ['Ali', 'Sara', 'mohamed', 'Ahmed']
print(Children[2]) # Output: mohamed

x = 0
for child in Children: 
    x += 1
    print(str(x) + "-" + child) # Output: 1 Ali, 2 Sara, 3 mohamed, 4 Mercer
#-----------------------------------------------------------------------------------------------------------------------------------------#

#Nested Lists
Students = [["Ali", 22, "A"], ["Sara", 21, "B"], ["Mohamed", 23, "C"]]
for student in Students:
    print("Name: " + student[0]) # Output: Name: Ali, Name: Sara, Name: Mohamed
    print("Age: " + str(student[1])) # Output: Age: 22, Age: 21, Age: 23
    print("Grade: " + student[2]) # Output: Grade: A, Grade: B, Grade: C
    #-----------------------------------------------------------------------------------------------------------------------------------------#
#Dictionaries
#Keys
#Values
